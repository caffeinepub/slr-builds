...
export interface _SERVICE {
  ...
  'seedItemsA': ActorMethod<[], undefined>,
  'seedItemsB': ActorMethod<[], undefined>,
  'seedBuildsA': ActorMethod<[], undefined>,
  'seedBuildsB': ActorMethod<[], undefined>,
  ...
  'sendVoiceChatMessage': ActorMethod<[string, string, string], bigint>,
  'getChatUserUID': ActorMethod<[string], [] | [string]>,
